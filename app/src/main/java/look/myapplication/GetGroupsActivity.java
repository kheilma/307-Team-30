...
public class GetGroupsActivity extends AsyncTask<String, Void, String> {
    private Context context;
    private boolean loggedIn;
    private String userName;

    public GetGroupsActivity(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            link = "http://l00k.000webhostapp.com/getGroups.php" + data;
