...
public class MakeFavoriteActivity extends AsyncTask<String, Void, String> {

    private Context context;
    private User user;

    public MakeFavoriteActivity(Context context, User user) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            link = "http://l00k.000webhostapp.com/makeFavorite.php" + data;
